/**
 * @file own/database/postgresql/oid.h
 * @brief IDs used for determining column types and such..
 * @copyright Copyleft 2022 "unrealinsanity". All rights reversed.
 * @ref https://github.com/olt/libpq/blob/master/oid/types.go
 */

#ifndef DATABASE_POSTGRESQL_OID_INCLUDED
#define DATABASE_POSTGRESQL_OID_INCLUDED
